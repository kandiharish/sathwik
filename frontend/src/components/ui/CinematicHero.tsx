...
const slides = [
  {
    ...
    description: 'Supporting healthier mothers.\nStrengthening healthier families.',
  ...
  },
  {
    ...
    description: 'Empowering students with\nmodern learning tools.',
    video: '/videos/school infrastructure.mp4',
  ...
  },
  {
    ...
    description: 'Building open-air gyms\nfor public health.',
    video: '/videos/rural developement.mp4',
      ...
      <div className="absolute inset-0 z-0">
        <AnimatePresence initial={false} mode="sync">
          ...
          >
              ...
              />
              {/* Deep blue/teal overlay for readability and premium cinematic feel */}
              <div className="absolute inset-0 bg-[#061928]/70 mix-blend-multiply" />
              <div className="absolute inset-0 bg-gradient-to-t from-[#020b14]/90 via-transparent to-[#020b14]/50" />
            </motion.div>
        </AnimatePresence>
      </div>
      ...
      <div className="absolute inset-0 z-10 flex flex-col items-center justify-center px-6 text-center -mt-32">
        ...
        <div className="h-[120px] md:h-[150px] flex items-center justify-center">
          <AnimatePresence mode="wait">
            ...
            >
              <h1 
                className="text-3xl md:text-4xl lg:text-5xl font-serif font-normal leading-snug tracking-wider whitespace-pre-line text-white"
        ...
        {/* STATIC Action Buttons & Trust Elements */}
        <div className="flex flex-col items-center gap-5 mt-4">
          <div className="flex flex-col sm:flex-row items-center gap-3">
            <Link to="/programs" className="bg-[#009966] hover:bg-[#008855] text-white px-6 py-2.5 rounded-full font-bold text-xs tracking-wide transition-all shadow-[0_4px_20px_rgba(0,153,102,0.4)] flex items-center gap-2">
              Explore Programs 
              <span className="bg-white text-[#009966] w-4 h-4 rounded-full flex items-center justify-center font-bold text-[10px] leading-none pr-[1px]">&rarr;</span>
            </Link>
            <button className="bg-transparent border border-white/40 hover:bg-white/10 text-white px-6 py-2.5 rounded-full font-bold text-xs tracking-wide transition-all flex items-center gap-2 backdrop-blur-sm">
          ...
          <div className="flex flex-col sm:flex-row items-center gap-3 mt-1">
            <div className="flex -space-x-2.5">
              <img src="https://images.unsplash.com/photo-1534528741775-53994a69daeb?w=100&h=100&fit=crop" alt="Volunteer" className="w-8 h-8 rounded-full border-2 border-[#061928] object-cover" />
              <img src="https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?w=100&h=100&fit=crop" alt="Volunteer" className="w-8 h-8 rounded-full border-2 border-[#061928] object-cover" />
              <img src="https://images.unsplash.com/photo-1494790108377-be9c29b29330?w=100&h=100&fit=crop" alt="Volunteer" className="w-8 h-8 rounded-full border-2 border-[#061928] object-cover" />
              <img src="https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=100&h=100&fit=crop" alt="Volunteer" className="w-8 h-8 rounded-full border-2 border-[#061928] object-cover" />
            </div>
            <div className="text-center sm:text-left">
              <p className="text-white font-bold text-xs leading-tight">
                <AnimatedNumber value={20000} />+ lives transformed
              </p>
