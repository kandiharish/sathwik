...
export const stories: Story[] = [
  {
    ...
    heroImage: '/real-cta/women_empowerment.webp',
    ...
    action: 'She enrolled in SRAYI Association’s women’s empowerment tailoring program, completing a 6-month intensive course.',
    change: 'Upon graduation, SRAYI Association provided her with a sewing machine as seed capital.',
  ...
  },
  {
    ...
    heroImage: '/RO plant janaagama/WhatsApp Image 2026-08-19 at 11.17.52 PM (2).webp',
    ...
    action: 'SRAYI Association installed a commercial-grade RO water purification plant directly on the school premises.',
  ...
  },
  {
    ...
    category: 'Healthcare',
    heroImage: '/blind school porject/WhatsApp Image 2026-08-19 at 11.13.24 PM (1).webp',
    ...
    action: 'SRAYI Association supplied BP monitors, an ECG machine, and emergency ward beds to the health center.',
    ...
    quote: {
      text: 'The medical equipment supplied by SRAYI Association has allowed us to perform basic diagnostic tests locally. We are saving lives by catching illnesses early.',
      author: 'Dr. Sharma',
